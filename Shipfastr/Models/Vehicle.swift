...
class Vehicle  {
    ...
    func addMarkers(uiViewController: MapViewController){
    ...
    func drawRouteOnMap(uiViewController: MapViewController) {
...
//         Move Camera to the location with animation
    ...
    @objc func animatePolylinePath(uiViewController: MapViewController) {
       ...
       if i < path.count() {
           ...
           newPolyline.map = uiViewController.mapView
           carMarker.map = uiViewController.mapView
